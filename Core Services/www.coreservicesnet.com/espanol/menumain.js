...
dhtmlMenu.addItem(new NavBarMenuItem("Hacia ISO-9000:2000", "javascript:parent.cuerpo.location='hacia90002000.htm'"));
dhtmlMenu.addItem(new NavBarMenuItem("SHA", "javascript:parent.cuerpo.location='proteccionintegral.htm'"));
