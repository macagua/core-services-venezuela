...
dhtmlMenu.addItem(new NavBarMenuItem("To ISO 9000:2000", "javascript:parent.body.location='towards90002000.htm'"));
...
dhtmlMenu.addItem(new NavBarMenuItem("String Vibration", "javascript:parent.body.location='stringvibration.htm'"));
myNavBar1.addMenu(dhtmlMenu);
...
dhtmlMenu.addItem(new NavBarMenuItem("String Vibration on line.", "javascript:parent.body.location='stringvibrationonline.htm'"));
myNavBar1.addMenu(dhtmlMenu);

dhtmlMenu = new NavBarMenu(100, 0);
dhtmlMenu.addItem(new NavBarMenuItem("&nbsp;&nbsp;            Wells", "javascript:parent.body.location='signon.asp'"));
myNavBar1.addMenu(dhtmlMenu);
...
dhtmlMenu.addItem(new NavBarMenuItem("Well Control",  "javascript:alert('Under Construction');", "target='_self'"));
myNavBar1.addMenu(dhtmlMenu);
...
dhtmlMenu.addItem(new NavBarMenuItem("&nbsp;&nbsp;Site Map", "javascript:parent.body.location='sitemap.htm'"));
myNavBar1.addMenu(dhtmlMenu);
